...
public class EmployeeController {
    ...
    public Msg searchEmpByNameOrId(@RequestParam("content") String content){
...
//        模糊查询，姓名中包含content的或者id为content的都会被搜索出来
        List<Employee> employees = employeeService.searchEmpByNameOrId(content);
...
//            校验成功
    ...
    @RequestMapping("/emps")
    @ResponseBody
    public Msg getEmpsUseJson(@RequestParam(value = "pn",defaultValue = "1") Integer pn){
        //        引入pageHelper分页查询，
//        在查询之前只需要调用PageHelper.startPage()，传入页码，以及每一页显示的数量
